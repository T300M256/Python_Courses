...
class Application(Frame):
    ...
    def __init__(self, master=None):
        """
        Establish the window structure, leaving some widgets accesible
        as application instance variables.Connect button click to search_mail
    ...
    def search_mail(self):
        ...
        (trying to make sense of the ddates) and slect the approprieate
        message from the database, displaying the suject lines of the
    ...
    def display_mail(self, event):
        """
        Displaay the messagge corresponding to the subject line that the 
