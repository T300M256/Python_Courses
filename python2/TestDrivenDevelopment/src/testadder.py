"""
Demonstrates the fundamental of unittest.
adder() is a function that lets you a'add' integers, strings and lists.
"""

from adder import adder # keep the tested code seperate from the tests
...
class TestAdder(unittest.TestCase):
    ...
    def test_numbers_and_list(self):
        self.assertEqual(adder(4,[1,2,3]), [1,2,3,4], "r + [1,2,3] should be [1,2,3,4]")
