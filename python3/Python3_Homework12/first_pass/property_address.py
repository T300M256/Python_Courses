...
if __name__ == "__main__":
    ...
    try:
        ...
        #ad = Address( name='Steve Holden', street_address='1972 Flying Circus', city='Arlington', state='VA', zip_code='123456' )
        #ad.setattr(zip_code='foobar')
    except ZipCodeError:
    ...
    print("Add",ad.name)
    print("zip:", ad.zip_code)
    print("Run complete "+str(ad))