...
class Bird(Bunch):
    ...
    def add(self, name, value):
        """
        Add an oject for the Bird to carry in its basket.
            Name is what you call the object.
            Value is the actual object being placced in the basket.
        """
...
if __name__ == "__main__":
    swallow = Bird(fruit=("cocunut", "orange"), drink="apple juice")
    swallow.add("cars", 3)
